...
exports.giveCommission = async (req, res) => {
  try {
    ...
    const noti = {
      ...
      detail: `รับเงินจากใบเสร็จเลขที่ ${
        req.body.invoice
      } จำนวน ${numberDigitFormat(
        vat_owner.amount
    ...
    if (member.upline.lv1 !== "-") {
      ...
      const notiLv1 = {
        ...
        detail: `ส่วนแบ่งจากผู้ใช้งานที่เราแนะนำ ใบเสร็จเลขที่ ${
          req.body.invoice
        } จำนวน ${numberDigitFormat(vat_lv1.amount)} บาท`,
        timestamp: dayjs(Date.now()).format(),
      };
    ...
    if (member.upline.lv2 !== "-") {
      ...
      const notiLv2 = {
        ...
        detail: `ส่วนแบ่งจากผู้ใช้งานที่เราแนะนำ ใบเสร็จเลขที่ ${
          req.body.invoice
        } จำนวน ${numberDigitFormat(vat_lv2.amount)} บาท`,
        timestamp: dayjs(Date.now()).format(),
      };
    ...
    if (member.upline.lv3 !== "-") {
      ...
      const notiLv3 = {
        ...
        detail: `ส่วนแบ่งจากผู้ใช้งานที่เราแนะนำ ใบเสร็จเลขที่ ${
          req.body.invoice
        } จำนวน ${numberDigitFormat(vat_lv3.amount)} บาท`,
        timestamp: dayjs(Date.now()).format(),
      };

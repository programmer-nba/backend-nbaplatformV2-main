...
app.use("/v2/nba-platform/flash", require("./routes/flash/index"));

//Counter service
app.use(
  "/v2/nba-platform/counter_service/mobile_topup",
  require("./routes/counterservice/mobile.topup")
);
app.use(
  "/v2/nba-platform/counter_service/card_topup",
  require("./routes/counterservice/card.topup")
);
app.use(
  "/v2/nba-platform/counter_service/mobile_bill",
  require("./routes/counterservice/mobile.bill")
);
app.use(
  "/v2/nba-platform/counter_service/barcode_service",
  require("./routes/counterservice/barcode")
);
app.use(
  "/v2/nba-platform/counter_service/nba_service",
  require("./routes/counterservice/nba")
);
app.use(
  "/v2/nba-platform/counter_service/wallet",
  require("./routes/counterservice/wallet")
);

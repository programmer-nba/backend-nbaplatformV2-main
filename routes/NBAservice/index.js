...
router.get(
  "/accountservice/package/listbycate/:id",
  auth,
  accountservice.GetServiceByCateId
);
...
router.get(
  "/actlegalservice/package/listbycate/:id",
  auth,
  actservice.GetServiceByCateId
);
...
router.get(
  "/insuranceservice/package/listbycate/:id",
  auth,
  insuranceservice.GetServiceByCateId
);
...
router.get(
  "/taxservice/package/listbycate/:id",
  auth,
  taxservice.GetServiceByCateId
);
